...
-- Keeping here cause I'll probably forget about it otherwise...
-- NOTE: commented out combo for now, will not have time to implement...
...
--  self.attackWeights["comboTest"] = 2/7
  ...
  self.counterAttack = self:loadAttack({name = "counterAttack", animName = "low_attack01", damage = ENEMY_ATTACK_COUNTER_DAMAGE, stance = "high"}, nil, 10)
end
--
...
function enemy:initializeSM()
  ...
  sm:add("taunt", {
      ...
      update = function(self, dt)
        ...
        if enemy.attacked then
          enemy.attacked = false
          enemy:changeHP(-PLAYER_NORMAL_DAMAGE) -- HARDCODED: damage
