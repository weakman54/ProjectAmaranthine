...
local InsideRobot = RM:loadAnimation("inside_robot_flipped_")
local InsideRobot_blur = RM:loadAnimation("inside_robot_blur_flipped_")

-- NOTE: The Original images are now called flipped here in code because we use the flipped image files as the standard InsideRobot.
local InsideRobot_flipped = RM:loadAnimation("inside_robot_")
    ...
    moments = {
      ...
      [2] = {
        ...
        anims = {
          ...
          EEnd = RM:loadAnimation("s03_0_p006_m01_End_"),
          Gas = Gas,
          InputBox = InputBox, TextBox = RM:loadAnimation("s03_0_p006_m02_Text_"),
        },
        transitionTrigger = {
          [1] = "waitForInput",
      ...
      [1] = {
        ...
        drawData = {
          [1] = {
            ...
            xOffset = 2320/2,
            yOffset = 1480/2,
            tween = {4.0, {x = 2320/2 - 200, y = 1480/2 - 200, xScale = 1, yScale = 1, }, "in-out-quad" },
          },
          [2] = {
            anim = "White",
            alpha = 1,
      ...
      [1] = {
        ...
        drawData = {
          ...
          [2] = {
            ...
            y = 200,
            alpha = 0, 
            tween = {3.0, {x = 0, y = 0, alpha = 1}, "in-quad"},
          },
        },
      },
    },
    ...
    moments = {
      [1] = {
        ...
        drawData = {
          [1] = {
            anim = "Zero",
            alpha = 1, tween = {1.0, {alpha = 0}, "in-linear"}
          },
          [2] = {
            anim = "Soldier",
            alpha = 0,
            ...
            xOffset = 2320/2,
            yOffset = 1480/2,
            tween = {3.0, {x = 2320/2 - 200, y = 1480/2 - 200, xScale = 1, yScale = 1, alpha = 1 }, "in-out-quad" },
          },
          [3] = {
            anim = "Effect",
      ...
      [1] = {
        ...
        drawData = {
          ...
          [3] = {
            ...
            alpha = 0, 
            x = - 200,
            tween = {3.0, {x = 0, alpha = 1}, "in-out-quad"}
      ...
      [1] = {
        ...
        drawData = {
          ...
          [2] = {
            ...
            alpha = 0, 
            x = 150,
            tween = {1.0, {x = 0, alpha = 1}, "out-quad"}
          },
        },
      },
    },
      ...
      [1] = {
        ...
        drawData = {
          ...
          [2] = {
            anim = "Zero",
            x = -200,
            alpha = 0, tween = {3.5, {x = 0, alpha = 1}, "in-out-quad"}
      ...
      [1] = {
        ...
        drawData = {
          ...
          [2] = {
            anim = "EEnd",
            x = - 300,
            alpha = 0, tween = {4.0, {x = 0, alpha = 1}, "in-out-quad"}
          },
        },
      },
    },
      ...
      [1] = {
        ...
        drawData = {
          ...
          [2] = {
            anim = "End2",
            x = - 100,
            alpha = 0, tween = {5.0, {x = 0, alpha = 1}, "in-quad"}
    ...
    moments = {
      [1] = {
        ...
        anims = {
          ...
          Effect = RM:loadAnimation("s03_0_p028_m01_Effect_"),
          Gas = Gas,
        },
        transitionTrigger = {
          [1] = "timer", [2] = 2.0,
  ...
  [29] = {
    ...
    moments = {
      [1] = {
        ...
        music = {"Behind_Your_Back", {fade = {duration = 4, rate = -1/3}}},
        anims = {
    ...
    moments = {
      [1] = {
        ...
        anims = {
          Quit = RM:loadAnimation("s03_0_p052_m01_Quit_"),
          Box = RM:loadAnimation("s03_0_p052_m01_Box_"),
          InputBox = InputBox, TextBox = RM:loadAnimation("s03_0_p052_m01_Text_"),
        },
        transitionTrigger = {
          [1] = "waitForInput", },
        drawData = {
